...
}catch (e12038){var _e__8701__auto__ = e12038;
return false;
...
}catch (e12042){var _e__8701__auto__ = e12042;
return false;
...
}catch (e12073){var _e__8701__auto__ = e12073;
return false;
...
}catch (e12077){var _e__8701__auto__ = e12077;
return false;
...
}catch (e12080){var _e__8701__auto__ = e12080;
return false;
}})())){
...
}catch (e12082){var _e__8701__auto__ = e12082;
return false;
}})())){
...
var _STAR_current_state_STAR__orig_val__12087 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__12088 = (function (){var or__4120__auto__ = config;
if(cljs.core.truth_(or__4120__auto__)){
return or__4120__auto__;
} else {
...
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__12088);

try{return (raw_fn.cljs$core$IFn$_invoke$arity$1 ? raw_fn.cljs$core$IFn$_invoke$arity$1(value) : raw_fn.call(null,value));
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__12087);
}});
});
...
return (function() { 
var G__12090__delegate = function (args){
...
while (G__12091__i < G__12091__a.length) {G__12091__a[G__12091__i] = arguments[G__12091__i + 0]; ++G__12091__i;}
  args = new cljs.core.IndexedSeq(G__12091__a,0,null);
} 
return G__12090__delegate.call(this,args);};
...
return G__12090__delegate(args);
});
