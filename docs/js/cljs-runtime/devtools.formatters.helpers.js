...
var G__11448 = devtools.prefs.pref(v);
v = G__11448;
continue;
} else {
return v;
...
}catch (e11336){var _e__8701__auto__ = e11336;
return false;
}})();
...
}catch (e11349){var _e__8701__auto__ = e11349;
return false;
}})();
...
}catch (e11351){var _e__8701__auto__ = e11351;
return false;
}}
}
});
...
var vec__11434 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11434,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11434,(1),null);
...
return cljs.core.some((function (p1__11441_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__11441_SHARP_);
}),template);
});
