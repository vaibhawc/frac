...
var o10922 = temp__5733__auto__;
var temp__5733__auto____$1 = (o10922["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o10923 = temp__5733__auto____$1;
return (o10923["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__8691__auto__ = f;
return (o__8691__auto__["toString"]).call(o__8691__auto__);
} else {
return "";
}
}catch (e10924){var _ = e10924;
return "";
}});
...
try{var o__8691__auto___11321 = t;
(o__8691__auto___11321["cljs$lang$ctorPrWriter"]).call(o__8691__auto___11321,t,writer);
}catch (e10927){var __11323 = e10927;
}
...
var char_code = (function (){var o__8691__auto__ = (new String(char$));
return (o__8691__auto__["charCodeAt"]).call(o__8691__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__8691__auto__ = String;
return (o__8691__auto__["fromCharCode"]).call(o__8691__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__10942 = num_code;
switch (G__10942) {
case (1):
return (185);
...
var o__8691__auto__ = String;
return (o__8691__auto__["fromCharCode"]).call(o__8691__auto__,superscript_code);
});
/**
...
}catch (e10957){var _e__8701__auto__ = e10957;
return false;
}})())){
...
var vec__10958 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10958,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o10971 = temp__5733__auto__;
var temp__5733__auto____$1 = (o10971["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o10972 = temp__5733__auto____$1;
return (o10972["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4730__auto___11408 = arguments.length;
var i__4731__auto___11409 = (0);
while(true){
if((i__4731__auto___11409 < len__4730__auto___11408)){
args__4736__auto__.push((arguments[i__4731__auto___11409]));

var G__11410 = (i__4731__auto___11409 + (1));
i__4731__auto___11409 = G__11410;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__10989){
var vec__10990 = p__10989;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10990,(0),null);
...
var G__11411 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__11412 = cljs.core.butlast(remaining_tokens);
name_tokens = G__11411;
remaining_tokens = G__11412;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq10982){
var G__10983 = cljs.core.first(seq10982);
var seq10982__$1 = cljs.core.next(seq10982);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10983,seq10982__$1);
}));
...
var vec__11001 = cljs.core.split_with((function (p1__10998_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__10998_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11001,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11001,(1),null);
...
var vec__11009 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11009,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11009,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__11415 = cljs.core.rest(remaining_tokens);
var G__11416 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__11415;
name_tokens = G__11416;
continue;
} else {
...
var vec__11024 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11024,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11024,(1),null);
var vec__11027 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11027,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11027,(1),null);
var vec__11030 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11030,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11030,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11030,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11030,(3),null);
...
var vec__11042 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11042,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11042,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11042,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11042,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11042,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11042,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__11045 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11045,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11045,(1),null);
var vec__11048 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11048,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11048,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__11053 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__11053) : devtools.munging.parse_fn_info_deep.call(null,G__11053));
})()));
}
} else {
return fn_info;
...
var G__11443 = (arity + (1));
var G__11444 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__11058){
var vec__11059 = p__11058;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11059,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11059,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__11065_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__11065_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__11066_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__11066_SHARP_);
}),sorted_infos);
...
var args__4736__auto__ = [];
var len__4730__auto___11458 = arguments.length;
var i__4731__auto___11459 = (0);
while(true){
if((i__4731__auto___11459 < len__4730__auto___11458)){
args__4736__auto__.push((arguments[i__4731__auto___11459]));

var G__11460 = (i__4731__auto___11459 + (1));
i__4731__auto___11459 = G__11460;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__11072){
var vec__11073 = p__11072;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11073,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq11067){
var G__11068 = cljs.core.first(seq11067);
var seq11067__$1 = cljs.core.next(seq11067);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11068,seq11067__$1);
}));
...
var G__11084 = arg;
var G__11084__$1 = (((G__11084 instanceof cljs.core.Keyword))?G__11084.fqn:null);
switch (G__11084__$1) {
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11131__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11131__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11131__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11131__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__11132 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11132,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11132,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11132,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11132,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11132,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11132,(5),null);
...
var o__8691__auto__ = f;
return (o__8691__auto__["getBasis"]).call(o__8691__auto__);
});
/**
...
}catch (e11153){var _e__8701__auto__ = e11153;
...
var G__11464 = (obj[cljs.core.first(path)]);
var G__11465 = cljs.core.rest(path);
obj = G__11464;
path = G__11465;
continue;
} else {
...
var _STAR_ = (function (accum,p__11247){
var vec__11248 = p__11247;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11248,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11248,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__11284){
var vec__11285 = p__11284;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11285,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11285,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11285,(2),null);
...
var post_process = (function (p__11297){
var vec__11298 = p__11297;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11298,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11298,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__11296_SHARP_){
return (obj[cljs.core.first(p1__11296_SHARP_)]);
}),sorted_matches);
