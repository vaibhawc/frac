...
var len__4730__auto___11765 = arguments.length;
var i__4731__auto___11766 = (0);
while(true){
if((i__4731__auto___11766 < len__4730__auto___11765)){
args__4736__auto__.push((arguments[i__4731__auto___11766]));

var G__11767 = (i__4731__auto___11766 + (1));
i__4731__auto___11766 = G__11767;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq11723){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11724,G__11725,seq11723__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__11730_SHARP_){
return (!((cljs.core.meta(p1__11730_SHARP_) == null)));
})))){
...
var map__11742 = opts;
var map__11742__$1 = (((((!((map__11742 == null))))?(((((map__11742.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__11742.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__11742):map__11742);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11742__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e11746){var _e__8701__auto__ = e11746;
return false;
}})();
if(cljs.core.truth_(or__4120__auto__)){
return or__4120__auto__;
...
}catch (e11750){var _e__8701__auto__ = e11750;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__11752 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__11753 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__11753);

try{var map__11754 = opts;
var map__11754__$1 = (((((!((map__11754 == null))))?(((((map__11754.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__11754.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__11754):map__11754);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11754__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__11752);
}});
...
var temp__5733__auto___11775 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___11775)){
var managed_print_level_11776 = temp__5733__auto___11775;
var _STAR_print_level_STAR__orig_val__11758_11777 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__11759_11778 = managed_print_level_11776;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__11759_11778);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__11756_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__11756_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__11758_11777);
}} else {
job_fn();
}
