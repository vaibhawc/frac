...
var G__12514 = o;
goog.object.set(G__12514,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__12547__i < G__12547__a.length) {G__12547__a[G__12547__i] = arguments[G__12547__i + 0]; ++G__12547__i;}
  args = new cljs.core.IndexedSeq(G__12547__a,0,null);
} 
...
var G__12519 = o;
goog.object.set(G__12519,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
return G__12549__delegate(args);
});
...
var G__12520 = props;
var G__12520__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12520,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__12520);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12520__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__12520__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__12521 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12521,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__12521;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__12522){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12523__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__12525_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__12525_SHARP_);
}));
} else {
return null;
}
...
var vec__12527 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12527,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12527,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12527,(2),null);
...
var temp__5739__auto___12571 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___12571 == null)){
} else {
var key_12573 = temp__5739__auto___12571;
(jsprops.key = key_12573);
}
...
var temp__5739__auto___12588 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___12588 == null)){
} else {
var key_12589 = temp__5739__auto___12588;
(jsprops.key = key_12589);
}
...
var G__12531 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__12531) : reagent.impl.template.as_element.call(null,G__12531));
} else {
var temp__5739__auto___12590 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5739__auto___12590 == null)){
} else {
var key_12592 = temp__5739__auto___12590;
(jsprops.key = key_12592);
}
...
var G__12533 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__12533)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__12533)){
return x;
} else {
...
var len__4730__auto___12597 = arguments.length;
var i__4731__auto___12598 = (0);
while(true){
if((i__4731__auto___12598 < len__4730__auto___12597)){
args__4736__auto__.push((arguments[i__4731__auto___12598]));

var G__12599 = (i__4731__auto___12598 + (1));
i__4731__auto___12598 = G__12599;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq12534){
var G__12535 = cljs.core.first(seq12534);
var seq12534__$1 = cljs.core.next(seq12534);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12535,seq12534__$1);
}));
...
break;
default:
var G__12601 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__12601;
continue;
...
var ctx = ({});
var vec__12538 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12538,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12538,(1),null);
...
var G__12541 = (cljs.core.count(argv) - first_child);
switch (G__12541) {
case (0):
