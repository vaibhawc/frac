...
if((i < len)){
var k = (ks[i]);
var G__12507 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),goog.object.get(o,k));
var G__12508 = (i + (1));
m = G__12507;
i = G__12508;
continue;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__12429 = c;
var G__12429__$1 = (((G__12429 == null))?null:G__12429.prototype);
if((G__12429__$1 == null)){
return null;
} else {
return G__12429__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__12432 = c;
var G__12432__$1 = (((G__12432 == null))?null:G__12432.prototype);
if((G__12432__$1 == null)){
return null;
} else {
return G__12432__$1.render;
}
})() == null)))));
});
...
var G__12495 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__12495) : reagent.impl.component.as_element.call(null,G__12495));
};
var G__12510 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__12511__i = 0, G__12511__a = new Array(arguments.length -  0);
while (G__12511__i < G__12511__a.length) {G__12511__a[G__12511__i] = arguments[G__12511__i + 0]; ++G__12511__i;}
  args = new cljs.core.IndexedSeq(G__12511__a,0,null);
} 
...
return G__12499__$1.displayName;
}
});
...
var _STAR_current_component_STAR__orig_val__12500 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__12501 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__12501);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__12500);
}});
...
var G__12502 = key;
var G__12502__$1 = (((G__12502 instanceof cljs.core.Keyword))?G__12502.fqn:null);
switch (G__12502__$1) {
...
var c = this;
var G__12505_12516 = goog.object.get(c,"cljsRatom");
if((G__12505_12516 == null)){
} else {
reagent.ratom.dispose_BANG_(G__12505_12516);
}
...
var renders_12517 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_12518 = cljs.core.first(cljs.core.vals(renders_12517));
...
if((cljs.core.count(renders_12517) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_12517))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_12518)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_12518], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__12506 = o;
goog.object.set(G__12506,cljs.core.name(k),v);
